...
ARG TERRAFORM_VERSION=null
ARG TERRAGRUNT_VERSION=null
ARG TFDOCS_VERSION=null
ARG TFLINT_VERSION=null
ARG TFSEC_VERSION=null
ARG TRIVY_VERSION=null
ARG EKSCTL_VERSION=null
...
ARG CHECKOV_VERSION=null
ARG PRE_COMMIT_VERSION=null
